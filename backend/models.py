...
class  Text(models.Model):
    message = models.ForeignKey(Message, on_delete=models.CASCADE, related_name='message_text')
    text = models.TextField()
...
class Response(models.Model):
    response = models.ForeignKey(Text, on_delete=models.CASCADE, related_name='responses')
    text = models.TextField()
    timestamp = models.DateTimeField(default=timezone.now)
